...
if (empty($search)) {
  ...
  $qr = "SELECT * FROM rfs_socios WHERE clube='$clube' AND status_socio=1 ORDER BY nome_socio ASC";
  $lis = mysqli_query($link, $qr) or die(mysqli_error($link));
  $totalRows_lis = mysqli_num_rows($lis);
} else {
  //Seleciona todos os sócios representativos
  $qr = "SELECT * FROM rfs_socios WHERE clube='$clube' AND status_socio=1 AND nome_socio LIKE '%" . $search . "%' ORDER BY nome_socio ASC";
  $lis = mysqli_query($link, $qr) or die(mysqli_error($link));
  $totalRows_lis = mysqli_num_rows($lis);
}
...
<body id="corpo">
        ...
        <div class="col-lg-12">
          ...
          <div class="user-data m-b-30">
            ...
            <form action="emite-mens-socios-mes.php" target="_blank" method="post" id="formsocio">
              ...
              <h3 style="margin-left: 25px"><i class="fas fa-user-friends"></i>Membros
                <a href="cd_socios.php<?php if ($_GET['clube']) {
                                        echo '?clube=' . $clube;
                                      } ?>" role="button" class="btn btn-success btrespons">
                  <i class="fas fa-plus"></i> Membro</a>
                ...
                <button class="btn btn-danger remove btrespons" type="submit" data-toggle="tooltip" title="Esta funcionalidade emite todos os boletos do mês referentes aos membros marcados abaixo."><i class="fas fa-barcode"></i> Emitir boleto(s)</button>
              ...
              <div class="row">
                <div class="col">
                  <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border" style="margin-left: 35px">
                    <select class="js-select2" name="mes" data-toggle="tooltip" title="Selecione o mês que deseja emitir todos os boletos dos membros selecionados">
                  ...
                  <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border" style="margin-left: 35px">
                    <select class="js-select2" name="ano" data-toggle="tooltip" title="Selecione o ano que deseja emitir todos os boletos dos membros selecionados">
                  ...
                  <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" name="valordif" class="form-control" placeholder="Valor especial" onKeyPress="return(moeda(this,'.',',',event))" data-toggle="tooltip" title="* (Opcional) - Aqui você pode digitar um novo valor para o mês dos membros selecionados.">
                  ...
                  <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" name="descdif" class="form-control" placeholder="Desconto especial" onKeyPress="return(moeda(this,'.',',',event))" data-toggle="tooltip" title="* (Opcional) - Aqui você pode digitar novo valor de desconto para os membros
    selecionados.">
                  ...
                  <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border ">
                    ...
                    <div class="input-group mb-2" style="width: 240px">
                      ...
                      <input type="date" name="vencdif" class="form-control" placeholder="Vencimento especial" data-toggle="tooltip" title="* (Opcional) - Aqui você pode digitar novo vencimento para os membros selecionados.">
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <td>Cobrança</td>
                    <td>Ativo?</td>
                    <td colspan="4" align="center"><?php echo "<strong style='margin-right: 5px; color: #ff0000;'>Total: </strong>" . $totalRows_lis; ?></td>
                ...
                <tbody>
                  ...
                  <?php if ($totalRows_lis <= 0) {
                    ...
                    <?php while ($row_lis = mysqli_fetch_assoc($lis)) { ?>
                      <div class="modal fade" id="<?php echo "pix-" . $row_lis['id_socio']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Em breve você poderá utilizar PIX para cobrar as mensalidades!
                            </div>
                            <div class="modal-footer">
                      ...
                      <tr>
                        <td>
                          <?php if ($row_lis['status_cob'] == 0 || $row_lis['status_socio'] == 0) {
                          } else { ?>
                            <label class="au-checkbox">
                        ...
                        <td>
                          <div class="table-data__info">
                            <h6><?php echo $row_lis['nome_socio']; ?> <?php if (!empty($row_lis['id_ri_socio'])) {
                                                                        echo "<strong>(" . $row_lis['id_ri_socio'] . ")</strong>";
                                                                      } ?></h6>
                        ...
                        <!--<td style="display:flex; justify-content: center">
                          ...
                          <a href="#" data-bs-toggle="modal" data-bs-target="<?php //echo "#pix-" . $row_lis['id_socio']; 
                                                                              ?>"><i class="fas fa-qrcode" style="font-size: 30px; color: #333;"></i></a>

                        </td>-->

                        <td style="text-align:center">
                          <form action="status-cobranca.php" method="post" id="form<?php echo $row_lis['id_socio']; ?>a" runat="server" onsubmit="ShowLoading()">
                            <input type="checkbox" <?php if ($row_lis['status_cob'] == 1) {
                                                      echo "checked";
                                                    } else {
                                                    } ?> data-toggle="toggle" onChange="document.forms['form<?php echo $row_lis['id_socio']; ?>a'].submit();" data-on="Sim" data-off="Não" data-onstyle="success" data-offstyle="danger" name="statuscob" value="<?php if ($row_lis['status_cob'] == 1) {
                                                                                                                                                                                                                                                                    echo "0";
                                                                                                                                                                                                                                                                  } else {
                                                                                                                                                                                                                                                                    echo "1";
                                                                                                                                                                                                                                                                  } ?>">
                        ...
                        <td style="text-align:center">
                          <form action="status-socio.php" method="post" id="form<?php echo $row_lis['id_socio']; ?>b" runat="server" onsubmit="ShowLoading()">
                            <input type="checkbox" <?php if ($row_lis['status_socio'] == 1) {
                                                      echo "checked";
                                                    } else {
                                                    } ?> data-toggle="toggle" onChange="document.forms['form<?php echo $row_lis['id_socio']; ?>b'].submit();" data-on="Sim" data-off="Não" data-onstyle="success" data-offstyle="danger" name="statussocio" value="<?php if ($row_lis['status_socio'] == 1) {
                                                                                                                                                                                                                                                                      echo "0";
                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                      echo "1";
                                                                                                                                                                                                                                                                    } ?>">
                        ...
                        <td>
                          <a href="edt-socios.php?id_socio=<?php echo $row_lis['id_socio']; ?><?php if ($_GET['clube']) {
                                                                                                echo '&clube=' . $clube;
                                                                                              } ?>">
                        ...
                        <td>
                          <a href="crop-socios.php?cod_usuario=<?php echo $row_lis['ref_socio']; ?><?php if ($_GET['clube']) {
                                                                                                      echo '&clube=' . $clube;
                                                                                                    } else {
                                                                                                      echo '&clube=' . $clube;
                                                                                                    } ?>" data-toggle="tooltip" title="Trocar imagem">
                            <i class="far fa-image"></i>
                          </a>
                        </td>
                        <!--<td>
                                                       <a href="excluir-socio.php?id_socio=<?php //echo $row_lis['id_socio'];
                                                                                            ?><?php //if($_GET['clube']){echo '&clube='.$clube;}
                                                                                              ?>" class="exclui">
                                                            <i class="zmdi zmdi-delete"></i>
                                                        </a>
                                                    </td>-->
                        <td>
                          <a href="mensalidades.php?idsoc=<?php echo $row_lis['id_socio']; ?>&filtroano=<?php echo date('Y'); ?><?php if ($_GET['clube']) {
                                                                                                                                  echo '&clube=' . $clube;
                                                                                                                                } ?>">
  ...
  <script>
    // Para selecionar todos os checkboxes dos membros
