...
<div class='row'>
	<div class='col-12 col-md-6'><strong>Ano de Gestão:</strong><?php echo $row_pegapauta['ano_rotario']; ?></div>
...
<div class='row' style='margin: 20px 0 20px 0'>
	<div class='col'><h2>Convidados</h2></div>
</div>

<div class='row' style='margin-top: 15px'>
	<div class='col'>
		<textarea class='form-control note' id='convi-recup' name='convi-recup' placeholder='Digite as informações anotadas sobre a seção de convidados.'><?php echo $row_pegaata['convi_recup'];?></textarea>
	</div>
</div>
...
<div class='row' style='margin: 20px 0 20px 0'>
	<div class='col'><h2>Diretoria Administração</h2></div>
</div>

<div class='row' style='margin-top: 15px'>
	<div class='col'>
		<textarea class='form-control note' id='com-admin' name='com-admin' placeholder='Digite as informações anotadas sobre a seção Diretoria Administração.'><?php echo $row_pegaata['com_admin'];?></textarea>
	</div>
</div>

<div class='row' style='margin: 20px 0 20px 0'>
	<div class='col'><h2>DDQA</h2></div>
</div>

<div class='row' style='margin-top: 15px'>
	<div class='col'>
		<textarea class='form-control note' id='sub-comp' name='sub-comp' placeholder='Digite as informações anotadas sobre a seção DDQA.'><?php echo $row_pegaata['sub_comp'];?></textarea>
	</div>
</div>

<div class='row' style='margin: 20px 0 20px 0'>
	<div class='col'><h2>Diretoria Projetos</h2></div>
</div>

<div class='row' style='margin-top: 15px'>
	<div class='col'>
		<textarea class='form-control note' id='com-proj' name='com-proj' placeholder='Digite as informações anotadas sobre a seção Diretoria de Projetos.'><?php echo $row_pegaata['com_proj'];?></textarea>
	</div>
</div>
