            ...
            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <small>Ajuste as informações sobre sua gestão</small>
                                    </div>
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="descricao_receber" class=" form-control-label">Logotipo</label>
												<input type="file" name="logotipo_clube" class="form-control">
											</div>
										</div>
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="descricao_receber" class=" form-control-label">Câmbio</label>
												<div class="input-group">
											        <div class="input-group-prepend">
											          <div class="input-group-text">R$</div>
											        </div>
											        <input type="text" class="form-control" id="cambio" name="cambio" onKeyPress="return(moeda(this,'.',',',event))" placeholder="Câmbio" value="<?php echo number_format($row_clubeinfo['cambio'],2,',','.');?>">
											      </div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12">
											<div class="form-group">
												<label for="descricao_receber" class=" form-control-label">Domínio do site (Opcional)</label>
												<div class="input-group">
											        <div class="input-group-prepend">
											          <div class="input-group-text"><i class="fas fa-globe"></i></div>
											        </div>
											        <input type="text" class="form-control" name="urldominio" placeholder="Digite o domínio do seu site. Ex.: https://www.meudominio.com.br" data-toggle="tooltip" title="Somente preencha este campo caso já tenha comprado um domínio para seu site e não queira utilizar o domínio padrão." value="<?php echo $row_clubeinfo['urldominio'];?>">
											      </div>
											</div>
										</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												<label for="n_conta" class=" form-control-label">Endereço</label>
