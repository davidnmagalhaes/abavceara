...
$sper12 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_vicepresidente}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi12 = $conexao->prepare($sper12);
$execupermi12 = $spermi12->execute();

$sper13 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_diretorsec}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi13 = $conexao->prepare($sper13);
$execupermi13 = $spermi13->execute();

$sper14 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_diretortes}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi14 = $conexao->prepare($sper14);
$execupermi14 = $spermi14->execute();

$sper15 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_diretorsoc}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi15 = $conexao->prepare($sper15);
$execupermi15 = $spermi15->execute();

$sper16 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_diretorpat}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi16 = $conexao->prepare($sper16);
$execupermi16 = $spermi16->execute();

$sper17 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_diretortur}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi17 = $conexao->prepare($sper17);
$execupermi17 = $spermi17->execute();

$sper18 = "INSERT INTO rfa_acesso_paginas(nivel_acesso, pagina_id, consulta_acesso, clube)VALUES('{$nivel_secexec}','{$pagina1}', '{$libera}', '{$lastclub}')";
$spermi18 = $conexao->prepare($sper18);
$execupermi18 = $spermi18->execute();
