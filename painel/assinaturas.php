            ...
            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-balance-wallet"></i>Assinaturas
                                        ...
                                        <table class="table">
											...
											<?php do {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                      <a href="https://<?php if($row_listasand['sandbox_pagseguro'] == 1){echo "sandbox.";}?>pagseguro.uol.com.br/v2/pre-approvals/request.html?code=<?php echo $row_listabancos['cod_plano'];?>" target="_blank">
