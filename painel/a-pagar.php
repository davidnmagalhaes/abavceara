                                    ...
                                    <table class="table table-data2">
										...
										<?php while($row_lis = mysqli_fetch_array($lis)){ ?>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="status--<?php if($row_lis['status_pagar'] == 1){echo "denied";}else{echo "process";};?>"><?php if($row_lis['recorrente']==1){echo "<i class='fas fa-history' style='margin-right: 5px; font-weight: bold;color: #2eaf37;' data-toggle='tooltip' data-placement='top' title='Despesa recorrente'></i>";}?><?php if($row_lis['status_pagar'] == 1){echo "Pendente";}else{echo "Pago";};?></span>
                                                </td>
