...
<head>
    ...
    <!-- Title Page-->
    <title>Cadastro de Receitas Previstas - Rotary Fortaleza Alagadiço</title>
                                    ...
                                    <div class="alert alert-success row" id="datasrecorrencias" style="display:none;">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_receita" id="descricao_receita" placeholder="Ex.: Valor referente ao recebimento de José" class="form-control" required>
											</div>
										</div>
										<div class="col" id="vencimento">
											<div class="form-group">
												<label for="data_receita" class=" form-control-label">Data de Recebimento</label>
												<input type="date" name="data_receita" id="data_receita" class="form-control">
											</div>
										</div>
										</div>
