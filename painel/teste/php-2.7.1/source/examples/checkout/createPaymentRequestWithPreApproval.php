...
class CreatePaymentRequestWithPreApproval
{
    ...
    public static function main()
    {
        ...
        $paymentRequest->setSender(
            'João Comprador',
            'c60008649220176109167@sandbox.pagseguro.com.br',
            '11',
            '56273440',
            'CPF',
            '156.009.442-76'
        ...
        $preApprovalRequest->setPreApprovalInitialDate('2020-01-03T00:00:00');
        $preApprovalRequest->setPreApprovalFinalDate('2021-09-09T00:00:00');
        ...
        try {
           ...
           /* $credentials = new PagSeguroAccountCredentials("pagseguro2@afetur.com.br",
                "e68b38aa-b9b9-4e7b-8de1-4b81e3988a8b6269d4dc47c590d8275827ac12ae9d466763-e912-4eab-bfbe-85f0b9100e47");*/
