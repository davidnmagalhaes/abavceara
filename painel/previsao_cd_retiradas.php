                                    ...
                                    <div class="alert alert-success row" id="datasrecorrencias" style="display:none;">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_retirada" id="descricao_retirada" placeholder="Ex.: Valor referente a retirada 13º salário" class="form-control" required>
											</div>
										</div>
                                        ...
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_retirada" onKeyPress="return(moeda(this,'.',',',event))" id="valor_retirada" class="form-control" required>
													</div>
