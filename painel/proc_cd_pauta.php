...
$urlreuniao = mysqli_real_escape_string($link,$_POST['url_reuniao']);
$loginreuniao = mysqli_real_escape_string($link,$_POST['login_reuniao']);
$senhareuniao = mysqli_real_escape_string($link,$_POST['senha_reuniao']);
