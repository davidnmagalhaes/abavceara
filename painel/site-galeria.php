...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
  <form action="proc_cd_site_galeria.php" method="post">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    <div class="card-header">
                                        <strong>Galeria de Presidentes</strong>
                                        <small> Gestão de Ex-Presidentes</small>
                                    </div>
                                    <div class="card-body card-block">
                                      ...
                                      <div class="col-12 col-md-3">
                                              <label for="titulo" class="col-form-label">Ano de Gestão Inicial:</label>
                                              <input type="text" name="ano_rotario_i" class="form-control" maxlength="4" placeholder="<?php $hoje = date('Y'); echo "Ex.: ".$hoje; ?>">
                                          </div>
                                          <div class="col-12 col-md-3">
                                              <label for="titulo" class="col-form-label">Ano de Gestão Final:</label>
