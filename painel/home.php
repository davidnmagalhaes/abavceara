...
$regra10 =  $totalRows_lisdatasimp < 1;
?>
      ...
      <div class="modal-body" style="padding: 0;">
        <div class="row">
            <div class="col" style="margin: 15px;">
                <strong>Olá! Seja bem vindo(a)! Temos alguns passos para que você possa começar a usar o sistema, veja abaixo:</strong><br><br>
            </div>
        </div>
        <?php 
           if($regra1){
        ...
        <?php 
           if($regra3){
               echo "<div class='row' style='margin: 15px'><div class='col-3 col-md-1'><img src='images/cancel.png'></div> <div class='col-9 col-md-11'>Preencha as informações da Abav que gerencia. <a href='configuracoes'>Clique para configurar...</a></div></div>";
            }
        ?>

        <?php 
           if($regra4){
               echo "<div class='row' style='margin: 15px'><div class='col-3 col-md-1'><img src='images/cancel.png'></div> <div class='col-9 col-md-11'>Você precisa começar a configurar o topo do site. <a href='topo'>Clique para configurar...</a></div></div>";
            }
        ?>
        ...
        <?php 
           if($regra7){
               echo "<div class='row' style='margin: 15px'><div class='col-3 col-md-1'><img src='images/cancel.png'></div> <div class='col-9 col-md-11'>Você precisa começar a configurar o conteúdo do site. <a href='conteudo'>Clique para configurar...</a></div></div>";
            }
        ?> 
        ...
        <?php 
           if($regra10){
               echo "<div class='row' style='margin: 15px'><div class='col-3 col-md-1'><img src='images/cancel.png'></div> <div class='col-9 col-md-11'>Cadastre as datas importantes, no menu <strong>reuniões</strong>.</div></div>";
            }
        ?> 
