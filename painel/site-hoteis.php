...
$qrh = "SELECT * FROM rfa_site_hoteis WHERE clube='$clube'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
  <form action="proc_cd_site_hoteis.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              ...
                                              <input type="text" name="titulo" class="form-control" placeholder="Digite o título do hotel" required>
                                          </div>
                                ...
                                <input type="hidden" name="club" value="<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>">
                                    ...
                                    <div class="card-header">
                                        <strong>Hotéis Cadastrados</strong>
...
<table class="table table-striped">
  <?php if($totalRows_lish <= 0){echo "<tr><td colspan='5' align='center'><strong>Não há hotéis cadastrados!</strong></td></tr>";}else{ ?>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <th style="vertical-align:middle;"><img src="<?php echo $row_lish['imagem_hotel']; ?>" style="width: 150px"></th>
      
      <td style="vertical-align:middle;"><?php echo $row_lish['nome_hotel']; ?></td>
      <td style="vertical-align:middle;"><a href="edt-hoteis.php?idhotel=<?php echo $row_lish['id_hotel']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-pen-alt"></i></a></td>
      <td style="vertical-align:middle;"><a href="excluir-site-hoteis.php?id_hotel=<?php echo $row_lish['id_hotel']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-trash"></i></a></td>
    </tr>
    <?php } ?>
