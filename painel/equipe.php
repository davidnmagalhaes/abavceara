...
$qr = "SELECT * FROM rfa_usuario WHERE (funcao='2' OR funcao='3' OR funcao='4' OR funcao='5' OR funcao='6' OR funcao='7' OR funcao='8' OR funcao='9') AND clube='$clube'";
                                        ...
                                        <table class="table">
											...
											<?php do{?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($row_lis['funcao'] == 1){echo "<span class='role admin'>Administrador</span>";
                                                      }elseif($row_lis['funcao'] == 2){
                                                        echo "<span class='role member'>Presidente</span>";
                                                      }elseif($row_lis['funcao'] == 3){
                                                        echo "<span class='role user'>Vice-Presidente</span>";
                                                      }elseif($row_lis['funcao'] == 4){
                                                        echo "<span class='role contador'>Diretor(a) Secretário(a)</span>";
                                                      }elseif($row_lis['funcao'] == 5){
                                                        echo "<span class='role tesoureiro'>Diretor(a) Tesoureiro(a)</span>";
                                                      }elseif($row_lis['funcao'] == 6){
                                                        echo "<span class='role executivo'>Diretor(a) Social</span>";
                                                      }elseif($row_lis['funcao'] == 7){
                                                        echo "<span class='role executivo'>Diretor(a) de Patrimônio</span>";
                                                      }elseif($row_lis['funcao'] == 8){
                                                        echo "<span class='role executivo'>Diretor(a) de Turismo Receptivo</span>";
                                                      }else{
                                                        echo "<span class='role executivo'>Secretário(a) Executivo(a)</span>";
                                                      }
                                                      ?>
                                                    </td>
                                                    <td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="padding: 15px">
      <form method="post" action="login-seguro/proc_edt_equipe.php" enctype="multipart/form-data">
                           ...
                           <option value="3" selected>Vice-Presidente</option>
                          <option value="4" >Diretor(a) Secretário(a)</option>
                          <option value="5" >Diretor(a) Tesoureiro(a)</option>
                          <option value="6">Diretor(a) Social</option>
                          <option value="7">Diretor(a) de Patrîmônio</option>
                          <option value="8">Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
												   <?php }elseif($row_lis['funcao'] == 4){?>
												   
                           <option value="3" >Vice-Presidente</option>
                          <option value="4" selected>Diretor(a) Secretário(a)</option>
                          <option value="5" >Diretor(a) Tesoureiro(a)</option>
                          <option value="6">Diretor(a) Social</option>
                          <option value="7">Diretor(a) de Patrîmônio</option>
                          <option value="8">Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
                        <?php }elseif($row_lis['funcao'] == 5){?>
                           <option value="3" >Vice-Presidente</option>
                          <option value="4" >Diretor(a) Secretário(a)</option>
                          <option value="5" selected>Diretor(a) Tesoureiro(a)</option>
                          <option value="6">Diretor(a) Social</option>
                          <option value="7">Diretor(a) de Patrîmônio</option>
                          <option value="8">Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
                          ...
                          <option value="4" >Diretor(a) Secretário(a)</option>
                          <option value="5" >Diretor(a) Tesoureiro(a)</option>
                          <option value="6" selected>Diretor(a) Social</option>
                          <option value="7">Diretor(a) de Patrîmônio</option>
                          <option value="8">Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
												   <?php }elseif($row_lis['funcao'] == 7){ ?>
                            <option value="3" >Vice-Presidente</option>
                          <option value="4" >Diretor(a) Secretário(a)</option>
                          <option value="5" >Diretor(a) Tesoureiro(a)</option>
                          <option value="6" >Diretor(a) Social</option>
                          <option value="7" selected>Diretor(a) de Patrîmônio</option>
                          <option value="8">Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
                        <?php }elseif($row_lis['funcao'] == 8){ ?>
                            <option value="3" >Vice-Presidente</option>
                          <option value="4" >Diretor(a) Secretário(a)</option>
                          <option value="5" >Diretor(a) Tesoureiro(a)</option>
                          <option value="6" >Diretor(a) Social</option>
                          <option value="7" >Diretor(a) de Patrîmônio</option>
                          <option value="8" selected>Diretor(a) de Turismo Receptivo</option>
                          <option value="9">Secretário(a) Executivo(a)</option>
                          ...
                          <option value="7" >Diretor(a) de Patrîmônio</option>
                          <option value="8" >Diretor(a) de Turismo Receptivo</option>
                          <option value="9" selected>Secretário(a) Executivo(a)</option>
                          <?php } ?>
