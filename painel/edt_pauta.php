                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
											<label for="nome_socio" class=" form-control-label">Ano de Gestão</label>
										...
										<div class="row">
												<div class="col">
														<label>URL da Reunião: (Opcional para reuniões digitais)</label>
														<div class="input-group mb-2">
															<div class="input-group-prepend">
															<div class="input-group-text"><strong><i class="fas fa-desktop"></i></strong></div>
															</div>
															<input type="text" class="form-control" name="url_reuniao" placeholder="Digite a URL da Reunião" value="<?php echo $row_pegapauta['url_reuniao']; ?>">
														</div>
												</div>
										</div>
										<div class="row">
												<div class="col">
														...
														<div class="input-group mb-2">
															<div class="input-group-prepend">
															<div class="input-group-text"><strong><i class="far fa-user"></i></strong></div>
															</div>
															<input type="text" class="form-control" name="login_reuniao" placeholder="Digite o login de acesso" value="<?php echo $row_pegapauta['login_reuniao']; ?>">
														</div>
												</div>
												<div class="col">
														...
														<div class="input-group mb-2">
															<div class="input-group-prepend">
															<div class="input-group-text"><strong><i class="fas fa-key"></i></strong></div>
															</div>
															<input type="text" class="form-control" name="senha_reuniao" placeholder="Digite a senha de acesso" value="<?php echo $row_pegapauta['senha_reuniao']; ?>">
														</div>
												</div>
										</div>
									...
									<!--Start - SUBCOMISSÃO DE COMPANHEIRISMO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="DDQA:" style="border:0; background: #fff; font-weight:bold;" readonly required>
											</div>
										</div>
									...
									<!--Start - COMISSÃO ADMINISTRAÇÃO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="DIR. ADMINISTRAÇÃO:" style="border:0; background: #fff; font-weight:bold;" readonly required>
											</div>
										</div>
									...
									<!--Start - COMISSÃO PROJETOS-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="DIR. PROJETOS:" style="border:0; background: #fff; font-weight:bold;" readonly required>
											</div>
										</div>
									...
									<!--Start - APRESENTAÇÃO PALESTRANTE-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="PALESTRANTE OU CONVIDADO:" style="border:0; background: #fff; font-weight:bold;" readonly>
											</div>
										</div>
...
<script>
	...
	iniciopres.value = resulalmoco;
	}
	
	
	//Calcula hora da PRESIDÊNCIA
	var horapres = resulalmoco;
