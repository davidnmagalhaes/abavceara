...
<body>
 ...
 <div class="main-content">
            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Fundos Previstas</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
										...
										<?php do{ ?>
                                            ...
                                            <div class="modal fade" id="deleterecorrente<?php echo $row_lis['id_prev_fundos'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Remover Fundo Recorrente</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form action="previsao-excluir-fundos.php" method="get">
                                                <input type="hidden" name="idfundo" value="<?php echo $row_lis['id_prev_fundos'];?>">
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc" contenteditable="true" data-old_value="<?php echo $row_lis['desc_prev_fundos']; ?>" onBlur="saveInlineEdit(this,'desc_prev_fundos','<?php echo $row_lis['id_prev_fundos']; ?>')" onClick="highlightEdit(this);" scope="row" ><?php if($row_lis['recorrente']==1){echo "<i class='fas fa-history' style='margin-right: 5px; font-weight: bold;color: #2eaf37;' data-toggle='tooltip' data-placement='top' title='Fundo recorrente'></i>";}?><?php echo $row_lis['desc_prev_fundos'];?></td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="previsao_duplicar_fundos.php?idfundo=<?php echo $row_lis['id_prev_fundos'];?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>" class="item" data-toggle="tooltip" data-placement="top" title="Duplicar"><i class="zmdi zmdi-copy"></i></a>

                                                        <a href="previsao_edt_fundos.php?idfundo=<?php echo $row_lis['id_prev_fundos'];?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>" class="item" >
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                       

                                                        <?php if($row_lis['recorrente']!=1){?>
                                                        <a href="previsao-excluir-fundos.php?idfundo=<?php echo $row_lis['id_prev_fundos'];?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>" class="item remove" data-toggle="tooltip" data-placement="top" title="Deletar">
                                                            <i class="zmdi zmdi-delete"></i>
                                                        </a>
                                                        <?php }else{ ?>
                                                        <a href="#" data-toggle="modal" data-target="#deleterecorrente<?php echo $row_lis['id_prev_fundos'];?>" class="item" data-toggle="tooltip" data-placement="top" title="Deletar">
                                                            <i class="zmdi zmdi-delete"></i>
                                                        </a>
                                                        <?php } ?>
