...
$qrh = "SELECT * FROM rfa_site_cias WHERE clube='$clube'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
  <form action="proc_cd_site_cias.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              <label for="titulo" class="col-form-label">Nome da Cia Aérea:</label>
                                              <input type="text" name="titulo" class="form-control" placeholder="Digite o título da cia aérea" required>
                                          </div>
                                ...
                                <input type="hidden" name="club" value="<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>">
                                    ...
                                    <div class="card-header">
                                        <strong>Cias Aéreas Cadastradas</strong>
...
<table class="table table-striped">
  <?php if($totalRows_lish <= 0){echo "<tr><td colspan='5' align='center'><strong>Não há cias aéreas cadastradas!</strong></td></tr>";}else{ ?>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <th style="vertical-align:middle;"><img src="<?php echo $row_lish['imagem_cia']; ?>" style="width: 150px"></th>
      
      <td style="vertical-align:middle;"><?php echo $row_lish['nome_cia']; ?></td>
      <td style="vertical-align:middle;"><a href="edt-cias.php?idcia=<?php echo $row_lish['id_cia']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-pen-alt"></i></a></td>
      <td style="vertical-align:middle;"><a href="excluir-site-cias.php?id_cia=<?php echo $row_lish['id_cia']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-trash"></i></a></td>
    </tr>
    <?php } ?>
