...
$qrh = "SELECT * FROM rfa_site_cursos WHERE clube='$clube'";
...
<body>
 ...
 <div class="main-content">
  <form action="proc_cd_site_cursos.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              ...
                                              <input type="text" name="titulo" class="form-control" placeholder="Digite o título do curso" >
                                          </div>
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              ...
                                              <input type="text" name="link" class="form-control" placeholder="Cole aqui um link de finalização de compra do curso" >
                                          </div>
...
<table class="table table-striped">
  <?php if($totalRows_lish <= 0){echo "<tr><td colspan='5' align='center'><strong>Não há cursos cadastrados!</strong></td></tr>";}else{ ?>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <th style="vertical-align:middle;"><img src="<?php echo $row_lish['imagem_curso']; ?>" style="width: 150px"></th>
      
      <td style="vertical-align:middle;"><?php echo $row_lish['titulo_curso']; ?></td>
      <td style="vertical-align:middle;"><a href="edt-cursos.php?idcurso=<?php echo $row_lish['id_curso']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-pen-alt"></i></a></td>
      <td style="vertical-align:middle;"><a href="excluir-site-cursos.php?id_curso=<?php echo $row_lish['id_curso']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-trash"></i></a></td>
    </tr>
    <?php } ?>
