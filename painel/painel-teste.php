...
//////////////////////////////////// Boletos avulsos totais ///////////////////////////////////////////
$sqblavul = "SELECT SUM(valor) as valor FROM rfa_boletos WHERE clube='$clube' AND MONTH(data_pgto) = '$filtromes' AND YEAR(data_pgto) = '$filtroano'";
$blavul = mysqli_query($link, $sqblavul) or die(mysqli_error($link));
$row_blavul = mysqli_fetch_assoc($blavul);
...
$totalgeral = ($row_mtgtotal['valor'] + $row_recpgtotal['valor'] + $row_sldtotal['valor'] + $row_blavul['valor']) - ($row_despesatotalg['valor'] + $row_txtotalg['valor'] + $row_fntotalg1['valor']);
$entradasgerais = ($row_mtgtotal['valor'] + $row_recpgtotal['valor'] + $row_sldtotal['valor'] + $row_blavul['valor']);
