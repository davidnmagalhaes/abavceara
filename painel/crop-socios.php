...
<html>
	<head>
		...
		<title>Imagem do Associado</title>
...
<script src="https://kit.fontawesome.com/13f03eba23.js" crossorigin="anonymous"></script>
	...
	<body>
				...
				$(function(){
					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							window.location = "https://www.abavceara.com.br/painel/socios";
						});
						return false;
					});
				});
		...
		<?php else: ?>
			<h1>UPLOAD DE IMAGEM DO ASSOCIADO</h1>
			...
			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-socios.php" enctype="multipart/form-data" runat="server"  onsubmit="ShowLoading(); ">
										...
										<div class="row" style="margin-bottom: 15px">
                                    		<div class="col-12">
                                                ...
                                                <span class="fake-btn"><strong style="color:#4272d7"><i class="fas fa-cloud-upload-alt" style="margin-right: 15px; font-size: 25px;"></i> Imagem do Associado</strong></span>
