...
<table cellpadding="0" cellspacing="0" border="0" width="600" style="font-family: calibri;">
 ...
 '.$nomeclube.', ainda não identificou em seu sistema o pagamento da sua mensalidade. Caso já tenha efetuado o pagamento, favor desconsiderar esta mensagem e se possível nos enviar cópia do comprovante scaneado.  O pagamento da mensalidade em dia é importante para a manutenção da  nossa entidade. Nova Abav-ce. Gestão: Juntos somos mais fortes!
	...
	<tr>
		<td style="padding: 30px;">
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<th style="width: 30%; padding: 3px; background: #7d7d7d; color: #fff; border: 2px solid #fff;">Nome do Associado:</th>
	...
	<tr>
		<td style="text-align:center; padding: 20px">
			<strong>Caso já tenha pago a mensalidade ignore este lembrete. Se encontrou dificuldades para realizar o pagamento entre em contato conosco.</strong>
			
		</td>
	</tr>
	<tr>
		<td style="background: #028541; height: 7px; border:0;"></td>
	</tr>

	<tr>
		<td style="background: #d1f3fc; height: 81px; border: 0; text-align:center;">
			<img src="https://'.$_SERVER['HTTP_HOST'].'/'.basename(__DIR__).'/images/logo-cartao-de-recuperacao-abav.png">
		</td>
	</tr>
