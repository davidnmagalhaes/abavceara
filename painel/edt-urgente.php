...
$idurgente = $_GET['idurgente'];
$club = $_GET['clube'];

$qrh = "SELECT * FROM rfa_site_urgente WHERE clube='$club' AND id_urgente='$idurgente'";
...
<body >
 ...
 <div class="main-content">
  <form action="proc_edt_site_urgente.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              ...
                                              <input type="text" name="titulo" class="form-control" value="<?php echo $row_lish['titulo_urgente'];?>" placeholder="Digite o título do post" >
                                          </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="grid-container">
                                          <div class="grid-width-100">
                                            ...
                                            <textarea id="summernote" name="descricao"><?php echo $row_lish['descricao_urgente'];?></textarea>
    <script>
        ...
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                console.error(textStatus + " " + errorThrown);
                                        ...
                                        <input type="hidden" name="idurgente" value="<?php echo $row_lish['id_urgente'];?>">
