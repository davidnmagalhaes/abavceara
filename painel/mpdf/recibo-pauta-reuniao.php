...
$dataanifilho = "";
if($totalRows_pegaaniversariofilho <= 0){$dataanifilho = "Não há titulares aniversariando esta semana!<br>";}else{
...
if($dataanifilho == ""){$dataanifilho .= "Não há titulares aniversariando esta semana!<br>";}
}
...
if($datanovaadm  == ""){$datanovaadm  .= "Não há novas admissões no clube nesta semana!<br>";}
 ...
 $html = "
 <fieldset>
<div style='text-align:center; margin: 10px auto;'><img src='../images/clube-digital.jpg' width='200' ></div>
 <h1>Pauta de Reunião | ".$row_pegaclube['nome_clube']."</h1>
 
<table>
	<tr>
		<td><strong>Ano de Gestão:</strong> ".$row_pegapauta['ano_rotario']."</td>
...
<table>
	...
	<tr >
		...
		<td style='background: #e2e2e2; padding: 2px; color: #000; text-align:center;'><strong>DDQA</strong></td>
	...
	<tr >
		...
		<td style='background: #e2e2e2; padding: 2px; color: #000; text-align:center;'><strong>Diretoria Administração</strong></td>
	...
	<tr >
		...
		<td style='background: #e2e2e2; padding: 2px; color: #000; text-align:center;'><strong>Diretoria Projetos</strong></td>
