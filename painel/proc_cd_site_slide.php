...
/*Variáveis do upload do banner*/
    foreach($titulobanner as $key => $titlebanner){
        ...
        if($delslide[$key]==1){
            ...
            $sql .= "INSERT INTO rfa_site_slides (img_mobile_topo, lado, ativo, img_banner_topo, banner_title, banner_sub,  banner_btn, link_botao, clube) VALUES ('$dirmobile','$posicao[$key]','$atv', '$dirbanner', '$titlebanner', '$subbanner[$key]', '$btnbanner[$key]', '$linkbotao[$key]','$club');";
            move_uploaded_file($tempbanner,$dirbanner);
            move_uploaded_file($tempmobile,$dirmobile);
        }
    }
