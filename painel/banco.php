                ...
                <div class="col-lg-12">
                    ...
                    <div class="user-data m-b-30">
                        <h3 class="title-3 m-b-30">
                            ...
                            <a class="btn btn-success" href="cd_banco.php<?php if ($_GET['clube']) {
                                                                                echo '?clube=' . $clube;
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-data__info">
                                                    ...
                                                    <i class="zmdi zmdi-balance-wallet" style="color:#5eac24"></i> <strong>CAIXA</strong>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="table-data__info">
                                                ...
                                                <div class="table-data__info">
                                                    ...
                                                    <span>
                                                        <strong>
                                                            ...
                                                            $mhjcx = date('m');
                                                            $ahjcx = date('Y');
                                                            $spgcx = "SELECT SUM(valor_pagar) as valor FROM rfa_pagar WHERE clube='$clube' AND MONTH(data_pagar) <= '$mhjcx' AND YEAR(data_pagar) <= '$ahjcx' AND status_pagar=2 AND origem_pagar='$orgbnccx'";
                                                            $pgcx = mysqli_query($link, $spgcx) or die(mysqli_error($link));
                                                            $row_pgcx = mysqli_fetch_array($pgcx);

                                                            //////////////////////////////////// Receitas Pagas no Geral ///////////////////////////////////////////
                                                            $srccx = "SELECT SUM(valor_receita) as valor FROM rfa_receitas WHERE clube='$clube' AND MONTH(data_receita) <= '$mhjcx' AND YEAR(data_receita) <= '$ahjcx' AND status_receita=2 AND destino_receita='$orgbnccx'";
                                            ...
                                            <td>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#editarbanco<?php echo $row_listacx['cod_banco']; ?>">
                                    ...
                                    <?php while ($row_listabancos = mysqli_fetch_array($listabancos)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-data__info">
                                                    ...
                                                    <?php if ($row_listabancos['conta_mensalidade'] == 1) {
                                                        echo "<strong><i class='zmdi zmdi-bookmark' style='color:#ff4b5a'></i> CONTA PRINCIPAL</strong>";
                                                    } else {
                                                    } ?>
                                                </div>
                                            </td>
                                                ...
                                                <div class="table-data__info">
                                                    ...
                                                    <span>
                                                        <a href="#"><strong>Ag.:</strong> <?php echo $row_listabancos['agencia']; ?> | <strong>Conta:</strong> <?php echo $row_listabancos['n_conta']; ?>
                                                            <br><strong><?php if ($row_listabancos['cnpj'] == 0) {
                                                                            echo "CPF";
                                                                        } else {
                                                                            echo "CNPJ";
                                                                        }; ?>.:</strong> <?php if ($row_listabancos['cnpj'] == 0) {
                                                                                                                                                                    echo $row_listabancos['cpf'];
                                                                                                                                                                } else {
                                                                                                                                                                    echo $row_listabancos['cnpj'];
                                                                                                                                                                }; ?></a>
                                                ...
                                                <div class="table-data__info">
                                                    ...
                                                    <span>
                                                        <strong>
                                                            ...
                                                            $mhj = date('m');
                                                            $ahj = date('Y');
                                                            $spg = "SELECT SUM(valor_pagar) as valor FROM rfa_pagar WHERE clube='$clube' AND MONTH(data_pagar) <= '$mhj' AND YEAR(data_pagar) <= '$ahj' AND status_pagar=2 AND origem_pagar='$orgbnc'";
                                                            $pg = mysqli_query($link, $spg) or die(mysqli_error($link));
                                                            $row_pg = mysqli_fetch_array($pg);
                                                            //////////////////////////////////// Mensalidades Pagas no Geral ///////////////////////////////////////////
                                                            $sms = "SELECT SUM(valor_mensalidade) as valor FROM rfa_mensalidades WHERE clube='$clube' AND MONTH(data_pagamento) <= '$mhj' AND YEAR(data_pagamento) <= '$ahj' AND pagamento=1";
                                                            $ms = mysqli_query($link, $sms) or die(mysqli_error($link));
                                                            $row_ms = mysqli_fetch_array($ms);
                                                            //////////////////////////////////// Taxas no Geral ///////////////////////////////////////////
                                                            $smstx = "SELECT SUM(taxa) as valor FROM rfa_mensalidades WHERE clube='$clube' AND MONTH(data_mensalidade) <= '$mhj' AND YEAR(data_mensalidade) <= '$ahj' AND pagamento=1";
                                                            $mstx = mysqli_query($link, $smstx) or die(mysqli_error($link));
                                                            $row_mstx = mysqli_fetch_array($mstx);
                                                            //////////////////////////////////// Receitas Pagas no Geral ///////////////////////////////////////////
                                                            $src = "SELECT SUM(valor_receita) as valor FROM rfa_receitas WHERE clube='$clube' AND MONTH(data_receita) <= '$mhj' AND YEAR(data_receita) <= '$ahj' AND status_receita=2 AND destino_receita='$orgbnc'";
                                            ...
                                            <td>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#editarbanco<?php echo $row_listabancos['cod_banco']; ?>">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                            </td>
                                            <td>
