...
$idvantagens = $_GET['idvantagens'];
$club = $_GET['clube'];

$qrh = "SELECT * FROM rfa_site_vantagens WHERE clube='$club' AND id_vantagens='$idvantagens'";
...
<body >
 ...
 <div class="main-content">
  <form action="proc_edt_site_vantagens.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12">
                                              ...
                                              <input type="text" name="titulo" class="form-control" value="<?php echo $row_lish['titulo_vantagens'];?>" placeholder="Digite o título da vantagem" >
                                          </div>
                                        ...
                                        <div class="grid-container">
                                          <div class="grid-width-100">
                                            ...
                                            <textarea id="summernote" name="descricao" placeholder="Digite a descrição da vantagem">
                                              <?php echo $row_lish['descricao_vantagens'];?>
                                            </textarea>
                                          </div>
                                        </div>
                                      </div>
...
['view', ['fullscreen', 'codeview', 'help', 'undo', 'redo']],
      ...
      placeholder: 'Digite seu conteúdo aqui...',
                                        ...
                                        <input type="hidden" name="idvantagens" value="<?php echo $row_lish['id_vantagens'];?>">
