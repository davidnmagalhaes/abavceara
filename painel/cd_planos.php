...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="pagseguro_assinatura/vendor/clubedigital/php-pagseguro/funcoes/assinatura/criar_plano.php" name="form-planos" runat="server"  onsubmit="ShowLoading()">
            <div class="col-lg-12">
                                <div class="card">
