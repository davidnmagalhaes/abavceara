...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo" style="font-size: 70px !important;">Doações</h1>
            </div>
                  ...
                  <div class="col-md-6">
                     <div class="contact-us">
                        <form method="post" class="comments-form" id="contactform">
                           <ul>
                              <li><input type="text" id="nome" name="nome" class="required" placeholder="Nome completo..."></li>
                              <li><input type="email" id="email" name="email" class="required email" placeholder="E-mail..."></li>
                              <li>
                                 <input type="text" name="cep" id="cep" placeholder="CEP..." style="width: 48% !important;" onkeypress="return somenteNumeros(event)" maxlength="8">
                                 <input type="text" name="estado" id="estado" placeholder="Estado..." style="width: 48% !important; margin-left: 4%;">
                              </li>
                              <li><input type="text" id="endereco" name="endereco" class="required" placeholder="Endereço..."></li>
                              <li>
                                 <input type="text" name="numero" id="numero" placeholder="Número..." style="width: 48% !important;">
                                 <input type="text" name="cidade" id="cidade" placeholder="Cidade..." style="width: 48% !important; margin-left: 4%;">
                              </li>

                              <li><input class="thbg-color" type="submit" value="CONTINUAR SOLICITAÇÃO"></li>
                           </ul>
