...
$ssoc = "SELECT * FROM rfa_site_entidades WHERE clube='$clube' ORDER BY nome_entidade ASC";
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo">Entidades</h1>
            </div>
      ...
      <section id="contant" class="contant main-heading team">
         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-2">
                  <div class="card">
                     <img class="img-responsive" src="../<?php echo $row_socios['imagem_entidade'];?>" style="width:100%">
               ...
               <div class="col-md-10 ">
                  <div class="card">
                     ...
                     <div class="">
                        <h2 style="margin-top: 15px"><?php echo $row_socios['nome_entidade'];?></h2>
                        <p class="title"><?php echo $row_socios['endereco_entidade'].", ".$row_socios['numero_entidade'].", ".$row_socios['bairro_entidade'].", ".$row_socios['cidade_entidade'].", ".$row_socios['estado_entidade'];?></p>
                        <p class="title">
                           <?php echo "<strong>Contatos: </strong>".$row_socios['telefone_entidade'];?>
                          
                           <br>
                           <?php echo $row_socios['email_entidade'];?>
