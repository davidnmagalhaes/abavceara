...
$iconeurgente = $row_licb['icone_urgente'];
$titulourgente = $row_licb['titulo_urgente'];
...
$sblog3 = "SELECT * FROM rfa_site_urgente WHERE clube='$clube' ORDER BY data_urgente, hora_urgente DESC LIMIT 6";
...
$sblog = "SELECT * FROM rfa_site_urgente WHERE clube='$clube'";
...
$sblog44 = "SELECT * FROM rfa_site_urgente WHERE clube='$clube' ORDER BY id_urgente DESC limit $incio, $quantidade_pg";
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container"> 
<h1 class="titulo-topo"><?php echo $titulourgente; ?></h1>
            </div>
               ...
               <div class="col-md-9">
                  <div class="feature-post">
                     ...
                     <div class="feature-img">
                        <img src="../<?php echo $row_blog44['imagem_urgente'];?>" class="img-responsive" alt="#" />
                     </div>
                     <div class="feature-cont">
                           ...
                           <div class="left-profile">
                              <div class="post-info">
                                 <?php 
                                    ...
                                    ?>
                                 <img src="<?php echo "../login-seguro/".$row_bl['imagem']; ?>" alt="#" />
                                 <span>
                                    
                                    <?php echo "<h4>Por ".$row_bl['nome']."</h4>"; ?>
                                    <h5>em <?php echo date('d/m/Y',strtotime($row_blog44['data_urgente']));?></h5>
                                 </span>
                              </div>
                        ...
                        <div class="post-heading">
                           <h3><?php echo $row_blog44['titulo_urgente'];?></h3>
                           <p class="short-description2"><?php echo str_replace('site/images/uploads/','images/uploads/',$row_blog44['descricao_urgente']);?>
                           </p>
                           <a href="single-urgente.php?clube=<?php echo $clube; ?>&id_urgente=<?php echo $row_blog44['id_urgente']; ?>" class="btn btn-primary" role="button">VER MAIS</a>
                        </div>
                     </div>
                  <?php } ?>
            ...
            <ul class="pagination">
               <?php 
                  ...
                  for($i = $inicio; $i <= $fim; $i++){
                     ...
                     if($i == $pagina){
                       ...
                       echo "<li ><a href='noticia-urgente.php?clube=".$clube."&pagina=$i'>".$i."</a></li>";
                     }
               ...
               <div class="col-md-3">
                 ...
                 <?php while($row_blog3 = mysqli_fetch_array($blog3)){?>
                  <aside id="sidebar" class="left-bar">
                     <div class="banner-sidebar">
                        <img class="img-responsive" src="../<?php echo $row_blog3['imagem_urgente'];?>" alt="#" />
                        <h3><a href="single-urgente.php?clube=<?php echo $clube; ?>&id_urgente=<?php echo $row_blog3['id_urgente']; ?>"><?php echo $row_blog3['titulo_urgente']; ?></a></h3>
                     </div>
                  </aside>
                  <?php } ?>
                  <!--<aside id="sidebar" class="left-bar">
