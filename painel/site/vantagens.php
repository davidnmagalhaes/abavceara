...
$ssoc = "SELECT * FROM rfa_site_vantagens WHERE clube='$clube' ORDER BY titulo_vantagens ASC";
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo" style="font-size: 70px !important;">Benefícios</h1>
            </div>
         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-3 column">
                  <div class="card2">
                     <img class="img-responsive" src="../<?php echo $row_socios['imagem_vantagens'];?>" style="width:100%">
                     <div class="">
                        <h4><?php echo $row_socios['titulo_vantagens'];?></h4>
                        <p style="text-align: center;">
                           <a href="#" class="btn btn-primary" style="margin:5px auto; float:none" data-toggle="modal" data-target="#modalExemplo<?php echo $row_socios['id_vantagens'];?>">SAIBA MAIS</a>
                        </p>
                        <p>
               ...
               <!-- Modal -->
               <div class="modal fade" id="modalExemplo<?php echo $row_socios['id_vantagens'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <h3 class="modal-title" id="exampleModalLabel"><Strong><?php echo $row_socios['titulo_vantagens'];?></Strong></h3>
                       <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                         <span aria-hidden="true">&times;</span>
                       </button>
                     </div>
                     <div class="modal-body" style="padding: 20px 20px 40px 20px">
                       <?php echo $row_socios['descricao_vantagens'];?>
                     </div>
