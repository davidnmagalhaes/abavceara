...
$ssoc = "SELECT * FROM rfa_site_parques WHERE clube='$clube' ORDER BY nome_parque ASC";
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo">Parques</h1>
            </div>
      ...
      <section id="contant" class="contant main-heading team">
         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-2">
                  <div class="card">
                     <img class="img-responsive" src="../<?php echo $row_socios['imagem_parque'];?>" style="width:100%">
               ...
               <div class="col-md-10 ">
                  <div class="card">
                     ...
                     <div class="">
                        <h2 style="margin-top: 15px"><?php echo $row_socios['nome_parque'];?></h2>
                        <p class="title"><?php echo $row_socios['endereco_parque'].", ".$row_socios['numero_parque'].", ".$row_socios['bairro_parque'].", ".$row_socios['cidade_parque'].", ".$row_socios['estado_parque'];?></p>
                        <p class="title">
                           <?php echo "<strong>Contatos: </strong>".$row_socios['telefone_parque'];?>
                          
                           <br>
                           <?php echo $row_socios['email_parque'];?>
