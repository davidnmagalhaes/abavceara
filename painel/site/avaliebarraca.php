...
$sqlqt = "SELECT * FROM rfa_questions WHERE clube='$clube' AND type='1' AND category='barraca'";
$questions = mysqli_query($link, $sqlqt) or die(mysqli_error($link));
$totalavaliacao = mysqli_num_rows($questions);

$sqlqt2 = "SELECT * FROM rfa_questions WHERE clube='$clube' AND type='2' AND category='barraca'";
$questions2 = mysqli_query($link, $sqlqt2) or die(mysqli_error($link));
$totalsatisfacao = mysqli_num_rows($questions2);

$sqlmemb = "SELECT * FROM rfs_socios WHERE clube='$clube' AND classif_socio='barraca' ORDER BY nome_socio ASC";
...
<body class="game_info" data-spy="scroll" data-target=".header">
  ...
  <section id="top">
    ...
    <div class="inner-page-banner">
      <div class="container">
        <h1 class="titulo-topo">Avalie uma barraca de praia</h1>
      </div>
    </div>
  </section>
                ...
                <div class="row" style="margin-bottom: 25px">
                  <div class="col-1">
                    <select name="categoria" style="width: 100%; padding: 10px 15px; border: solid #ccc 1px;">
                      <option selected disabled>Escolha uma barraca...</option>
