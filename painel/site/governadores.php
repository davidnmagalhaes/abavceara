         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-3 column">
                  <div class="card2">
                     <img class="img-responsive" src="../<?php if(empty($row_socios['imagem_governador']) && $row_socios['sexo'] =='m'){echo 'images/male.jpg';}elseif(empty($row_socios['imagem_governador']) && $row_socios['sexo'] =='f'){echo 'images/female.jpg';}else{echo $row_socios['imagem_governador'];}?>" style="width:100%">
                     <div class="">
