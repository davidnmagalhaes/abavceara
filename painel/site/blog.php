               ...
               <div class="col-md-9">
                  <div class="feature-post">
                     ...
                     <div class="feature-img">
                        <img src="../<?php echo $row_blog44['imagem_blog'];?>" class="img-responsive" alt="#" />
                     </div>
                     <div class="feature-cont">
                        ...
                        <div class="post-heading">
                           ...
                           <p class="short-description2"><?php echo html_entity_decode($row_blog44['descricao_blog']);?>
                           </p>
            ...
            <ul class="pagination">
               ...
               <div class="col-md-3">
                 ...
                 <?php while($row_blog3 = mysqli_fetch_array($blog3)){?>
                  <aside id="sidebar" class="left-bar">
                     <div class="banner-sidebar">
                        <img class="img-responsive" src="../<?php echo $row_blog3['imagem_blog'];?>" alt="#" />
